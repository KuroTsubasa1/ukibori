...
(function () {
  ...
  function bildDoc(el){const d=defaultDoc();d.body.shape="image";d.body.thicknessMm=3;d.body.baseColor="#101010";d.body.layerHeightMm=0.2;d.resolution=64;d.mount={type:"none",xMm:0,yMm:0,diameterMm:5,ringThicknessMm:0,ringHeightMm:2,marginMm:8};d.elements=[el];return d;}
